...
class SE3Control(object):
    ...
    def __init__(self, quad_params):
        ...
        self.kp_position = np.array([15, 15, 17]) # proportional gains for x, y, z control
        self.kd_position = np.array([7, 7, 5]) # derivation gains for x, y, z control

        # Define PD control gains for attitude (rotational dynamics)
        self.kp_phi = 2300 # Roll control P gain
