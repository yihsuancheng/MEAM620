...
class SE3Control(object):
    ...
    def __init__(self, quad_params):
        ...
        self.kp_position = np.array([12, 12, 20]) # proportional gains for x, y, z control
        ...
        self.kp_phi = np.diag(np.array([300, 300, 10]))#2700 # Roll control P gain
        self.kd_phi = np.diag(np.array([20, 20, 5]))#350 # Roll control D gain
