...
#from meam620.proj1_3.code.se3_control_null import SE3Control
...
#stopped_at_goal = np.linalg.norm(state['x'][-1] - goal) <= 0.02 and np.linalg.norm(state['v'][-1]) <= 0.03
#print("state norm", np.linalg.norm(state['x'][-1] - goal))
#print("velocity norm", np.linalg.norm(state['v'][-1]))
