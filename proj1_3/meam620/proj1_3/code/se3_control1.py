...
class SE3Control(object):
    ...
    def __init__(self, quad_params):
        ...
        self.kp_position = np.array([15, 15, 30]) # proportional gains for x, y, z control
        self.kd_position = np.array([7, 7, 10]) # derivation gains for x, y, z control

        # Define PD control gains for attitude (rotational dynamics)
        self.kp_phi = 2700 # Roll control P gain
        self.kd_phi = 350 # Roll control D gain
