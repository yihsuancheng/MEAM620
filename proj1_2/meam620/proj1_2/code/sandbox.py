...
# Hypothetical resolutions to test
resolutions = [(0.4, 0.4, 1.0), (0.3, 0.3, 1.0), (0.2, 0.2, 1.0), (0.10, 0.10, 1.0)]
# Placeholder for results
results = {"dijkstra": [], "astar": []}

# Placeholder loop for running experiments
# for resolution in resolutions:
#     #Run Dijkstra
#     path, nodes_expanded = graph_search(world, resolution, margin, start, goal, astar=False)
#     results["dijkstra"].append(nodes_expanded)
    
#     #Run A*
#     path, nodes_expanded = graph_search(world, resolution, margin, start, goal, astar=True)
#     results["astar"].append(nodes_expanded)
# resolution_values = [res[0] for res in resolutions]  # Extract x-resolution
# #Placeholder plotting code
# plt.figure(figsize=(10, 6))
# plt.plot(resolution_values, results["dijkstra"], label='Dijkstra')
# plt.plot(resolution_values, results["astar"], label='A*')
# plt.xlabel('Resolution')
# plt.ylabel('Nodes Expanded')
# plt.title('Performance Comparison of Dijkstra and A*')
# plt.legend()
# plt.grid(True)
# plt.show()